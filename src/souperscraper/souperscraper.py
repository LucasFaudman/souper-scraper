...
class SouperScraper:
    def __init__(self,
        ...
        if executable_path and "executable_path" not in selenium_service_kwargs:
            selenium_service_kwargs["executable_path"] = executable_path
    ...
    def __getattr__(self, attr):
        ...
        elif attr in dir(super().__getattribute__("webdriver")):
            return getattr(super().__getattribute__("webdriver"), attr)
        
        split_attr = attr.split('_')
        if 'soup' in split_attr:
    ...
    def _get_window_handle_by_index(self, index):
    ...
    def _get_window_handle_by_title(self, title):
    ...
    def _get_window_handle_by_url(self, url):
    ...
    def switch_to_window(self, index=None, title=None, url=None, window_handle=None):
        if index:
    ...
    def switch_to_tab(self, index=None, title=None, url=None, window_handle=None):
        return self.switch_to_window(index, title, url, window_handle)


    def new_tab(self, url=None, sleep_secs=None):
        self._new_window_handle('tab', url, sleep_secs)
  
    
    def new_window(self, url=None, sleep_secs=None):
        self._new_window_handle('window', url, sleep_secs)


    def goto(self, url, sleep_secs=None):
    ...
    def _wait(self, method, *method_args, timeout=3.0, poll_frequency=0.5, ignored_exceptions=None, until=True):
    ...
    def wait_until(self, expected_condition, *expected_condition_args, timeout=3.0, poll_frequency=0.5, ignored_exceptions=None):
    ...
    def wait_until_not(self, expected_condition, *expected_condition_args, timeout=3.0, poll_frequency=0.5, ignored_exceptions=None):
        """Wait for element with expected_condition(locator, locator_value) or return None if timeout"""
    ...
    def wait_for(self, expected_condition, *expected_condition_args, timeout=3.0, poll_frequency=0.5, ignored_exceptions=None):
        """Wait for element with expected_condition(locator, locator_value) or return None if timeout"""
        return self._wait(expected_condition, *expected_condition_args, timeout=timeout, poll_frequency=poll_frequency, ignored_exceptions=ignored_exceptions)

    def wait_for_not(self, expected_condition, *expected_condition_args, timeout=3.0, poll_frequency=0.5, ignored_exceptions=None):
        """Wait for element with expected_condition(locator, locator_value) or return None if timeout"""
        return self._wait(expected_condition, *expected_condition_args, timeout=timeout, poll_frequency=poll_frequency, ignored_exceptions=ignored_exceptions, until=False)
